...
BuildI18n(l) {
    if (l = "en") {
        return Map(
            ...
            "label_loadout", "Loadout",
            "preset_active_marker", "●",
            "preset_none_active", "No active loadout",
            "preset_active_fmt", "Active: {1}",
            "preset_save_short", "Save",
            "preset_create_short", "Create",
            "label_search", "Search",
    ...
    return Map(
        ...
        "label_loadout", "Loadout",
        "preset_active_marker", "●",
        "preset_none_active", "Nenhum loadout ativo",
        "preset_active_fmt", "Ativo: {1}",
        "preset_save_short", "Salvar",
        "preset_create_short", "Criar",
        "label_search", "Buscar",
